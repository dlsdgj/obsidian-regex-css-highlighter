...
SwiftGlossa-demo(zh): https://github.com/dlsdgj/Obsidian-SwiftGloss-demo

# SwiftGlossa / 积微探赜(zé) 

> **Note**: SwiftGlossa was formerly named **SwiftGloss** (v1.9.3 and earlier). The plugin ID remains `regex-css-highlighter` for compatibility.
> 注意：SwiftGlossa 原名 **SwiftGloss**（v1.9.3及更早版本）。插件ID保持 `regex-css-highlighter` 不变以兼容升级。
